...
// Node.js < 22 lacks native WebSocket, causing createClient() to throw.
// Must be set at TOP before any module loading.
class MockWebSocket {
...
jest.mock('expo-sqlite', () => {
  ...
  return {
    openDatabaseAsync: jest.fn().mockResolvedValue(dbMock),
  };
});
